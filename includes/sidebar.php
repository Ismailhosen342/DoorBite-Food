<aside class="sidebar">
    <div class="sidebar-logo">
        ...
        <span class="logo-text">DoorBite Food!</span>
    </div>
    <div class="sidebar-subtitle">Snack & Food Management</div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="inventory.php" class="nav-item <?php echo $currentPage === 'inventory' ? 'active' : ''; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
